    ...
    def _generate_beam_search(
        ...
        while cur_len < max_length:
            ...
            for batch_idx in range(batch_size):
                ...
                if done[batch_idx]:
                    ...
                    ), "generated beams >= num_beams -> eos_token_ids and pad_token have to be defined"
                ...
                for beam_token_rank, (beam_token_id, beam_token_score) in enumerate(
                    ...
                    if (eos_token_ids is not None) and (token_id.item() == eos_token_ids):
        ...
        for batch_idx in range(batch_size):
            ...
            if eos_token_ids is not None and all(
                (token_id % vocab_size).item() != eos_token_ids for token_id in next_tokens[batch_idx]
            ):
                assert torch.all(
        ...
        output_batch_size = batch_size if do_sample else batch_size * 1
        output_num_return_sequences_per_batch = 1 if do_sample else 1
