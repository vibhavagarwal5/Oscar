...
def get_args():
    ...
    parser.add_argument("--image_data_dir",
                        default='/home/hdd1/vibhav/VE-SNLI/mycode-vesnli/dataset/flickr30/det1_50_obj/', type=str, required=False,
                        help="The input data dir with all required files.")
    ...
    parser.add_argument("--drop_out", default=0.1,
                        type=float, help="Drop out in BERT.")
    ...
    parser.add_argument("--code_voc", default=512, type=int,
                        help="dis_code_voc: 256, 512")
    parser.add_argument("--code_level", default='top',
                        type=str, help="code level: top, botttom, both")
    parser.add_argument("--classifier", default='linear',
                        type=str, help="linear or mlp")
    parser.add_argument("--cls_hidden_scale", default=2,
                        type=int, help="cls_hidden_scale: for classifier")
